        ...
        <table className="w-full caption-bottom text-sm border-collapse">
          ...
          <tbody className="[&_tr:last-child]:border-0">
            {[
              ...
              { name: "Pixiv 助手", desc: "提供 Pixiv 插画搜索、画师推荐、作品关注、定时推送及群聊黑名单管理功能", usage: "<b>[基础指令]</b><br><code>pixiv帮助</code> : 查看详细指令说明<br><code>看看图 <PID></code> : 查看指定 ID 的插画<br><code>来张图</code> : 获取一张随机推荐插画<br><code>来<N>张<Tag>图</code> : 按标签搜索插画 (如: 来3张初音图)<br><code>来<N>张<画师>老师的图</code> : 按画师名搜索插画<br><code>来张色图</code> : (仅限R18群) 随机获取高质量 R18 插画<br><code>pixiv日榜/周榜/月榜</code> : 获取对应时间段的排行榜 Top 10 插画<br><br><b>[订阅与关注] (需管理员权限)</b><br><code>pixiv关注 添加 <画师名></code> : 关注画师，有新作品时推送<br><code>pixiv关注 删除 <画师名></code> : 取消关注<br><code>pixiv关注 列表</code> : 查看本群关注列表<br><code>pixiv订阅 添加 <tag/user> <关键词> <HH:mm></code> : 添加每日定时推送<br><code>pixiv订阅 删除 <索引></code> : 删除指定订阅任务<br><code>pixiv订阅 列表</code> : 查看本群订阅列表<br><code>pixiv日榜订阅 开启/关闭</code> : 开启/关闭每日 Pixiv 日榜 Top 10 推送 (06:00)<br><br><b>[管理指令] (需管理员/超管权限)</b><br><code>pixiv r18 开启/关闭</code> : 开启或关闭本群 R18 内容显示<br><code>pixiv黑名单 添加/删除/状态</code> : (仅超管) 管理本群插件禁用状态 (默认所有群可用)", at: "否", note: "" },
